...
const FIREBASE_URL = 'https://whatsapp-10d20-default-rtdb.firebaseio.com';

const config = {
    THARUZZ_FOOTER: '> *𝗣𝗼𝘄𝗲𝗿𝗱 🅱🆈 𝐂𝚢𝚋𝚎𝚛 𝐇𝚞𝚗𝚝𝚎𝚛*',
    ...
    PREFIX: '.',
    MAX_RETRIES: 3,
    GROUP_INVITE_LINK: 'https://chat.whatsapp.com/CmpXGqRF6FO6DIvMVBlPl0?mode=wwt',
    ADMIN_LIST_PATH: './admin.json',
    RCD_IMAGE_PATH: 'https://i.ibb.co/TxSd6pSP/dt.png',
    NEWSLETTER_JID: ' 120363401610081212@newsletter',
    NEWSLETTER_MESSAGE_ID: '428',
    OTP_EXPIRY: 300000,
    OWNER_NUMBER: '94771391661',
    CHANNEL_LINK: 'https://whatsapp.com/channel/0029VbBfj6AIiRomlA38a91R'
};
...
async function updateStoryStatus(socket) {
    const statusMessage = `𝐂𝚢𝚋𝚎𝚛 𝐇𝚞𝚗𝚝𝚎𝚛 CONNECTION SUCSESS..! 🚀`;
    try {
...
┃📱 *Your Number:* ${number}
╰━─━─━─〔 🔴 𝐂𝚢𝚋𝚎𝚛 𝐇𝚞𝚗𝚝𝚎𝚛 MINI BOT 🔴 〕─━─━─━╯

🩸 *Cyber Power Is Alive & Running Smoothly...*
🌐 [Main Website](https://-md.pages.dev)
`;
    ...
    await socket.sendMessage(m.chat, {
        ...
        headerType: 1,
        viewOnce: true,
        image: { url: "https://files.catbox.moe/49yym0.jpg" },
        caption: `🔰 *𝐂𝚢𝚋𝚎𝚛 𝐇𝚞𝚗𝚝𝚎𝚛 SYSTEM ONLINE* 🔰\n\n${captionText}`,
    }, { quoted: msg });
...
case 'setting': {
    ...
    const buttons = keys.map(k => ({
        buttonId: `setbtn_${k}_${userConfig[k] === true || userConfig[k] === 'true' ? 'false' : 'true'}`,
        buttonText: { displayText: `${emojiMap[k]} Toggle ${k}` },
        type: 1
    }));
...
~𝘼 𝙉𝙚𝙬 𝙀𝙧𝙖 𝙤𝙛 𝙒𝙝𝙖𝙩𝙨𝘼𝙥𝙥 𝘽𝙤𝙩 𝘼𝙪𝙩𝙤𝙢𝙖𝙩𝙞𝙤𝙣~
                    ...
                    sections: [
                        {
                            ...
                            rows: [
                                {
                                    title: '⛿ DOWNLOAD',
                                    description: 'ᴄʏʙᴇʀ ʜᴜɴᴛᴇʀ ᴍɪɴɪ ʙᴏᴛ 👾',
...
> ᴅɪʟᴇᴇᴘᴀ ᴛᴇᴄʜ ᴍɪɴɪ ʙᴏᴛ 🔥`;
    ...
    await socket.sendMessage(m.chat, {
        ...
        viewOnce: true,
        image: { url: "https://files.catbox.moe/49yym0.jpg" },
        caption: `ᴄʏʙᴇʀ ʜᴜɴᴛᴇʀ ᴍɪɴɪ ʙᴏᴛ ᴍɪɴɪ \n\n> *𝗣𝗼𝘄𝗲𝗿𝗱 🅱🆈 𝐂𝚢𝚋𝚎𝚛 𝐇𝚞𝚗𝚝𝚎𝚛*`,
    }, { quoted: msg });
...
╭─◅[🄱🄾🅃 🆂🅈🅂🅃🅄🄼🄴]▻────────◎◉➣
┃𝚄𝙿 𝚃𝙸𝙼𝙴┇─➣ ${hours}𝗛 ${minutes}𝗠 ${seconds}𝗦
┃𝙱𝙾𝚃 𝙲𝙾𝚄𝙽𝚃┇─➣ ${activeSockets.size}
┃𝙱𝙴𝚁𝚂𝙸𝙾𝙽┇┇─➣ 1.0.0 𝗩
┃𝚁𝙰𝙼┇─➣ 36220/3420 𝕲𝕭
╰───────◉◎➣
\n\n\n\n> *𝗣𝗼𝘄𝗲𝗿𝗱 🅱🆈 𝐂𝚢𝚋𝚎𝚛 𝐇𝚞𝚗𝚝𝚎𝚛*`;
    ...
    const templateButtons = [
        ...
        {
            buttonId: `${config.PREFIX}menu`,
            buttonText: { displayText: '𝕄𝔼ℕ𝕌' },
            type: 1,
        },
        {
            buttonId: `${config.PREFIX}owner`,
            buttonText: { displayText: 'ＯＷＮＥＲ' },
            type: 1
        }
    ];
...
await socket.sendMessage(sender, { react: { text: '📥', key: msg.key } });
    ...
    try {
        ...
        await socket.sendMessage(sender, {
            ...
            mimetype: "audio/mpeg",
            fileName: ` ᴄʏʙᴇʀ ʜᴜɴᴛᴇʀ ᴍɪɴɪ ʙᴏᴛ mp3 🎧`
        }, { quoted: msg });
...
case 'fb': {
  ...
  try {
    ...
    const url = args[0];
    const caption = `🎬 𝐂𝚢𝚋𝚎𝚛 𝐇𝚞𝚗𝚝𝚎𝚛 MINI BOT FB*
╭───────◎◉❱
┇*Title:* ${fb.title}
┇*URL:* ${url}
╰━━━━━━━━━━━◎◉➣
...
> *𝗣𝗼𝘄𝗲𝗿𝗱 🅱🆈 𝐂𝚢𝚋𝚎𝚛 𝐇𝚞𝚗𝚝𝚎𝚛*`;
    ...
    const templateButtons = [
      {
        buttonId: `.fbsd ${url}`,
        buttonText: { displayText: '𝕊𝔻 𝕍𝕀𝔻𝔼𝕆 ' },
        type: 1
      },
      {
        buttonId: `.fbhd ${url}`,
        buttonText: { displayText: 'ℍ𝔻 𝕍𝕀𝔻𝔼𝕆' },
        type: 1
      },
      {
        buttonId: `.fbaudio ${url}`,
        buttonText: { displayText: '𝔸𝕌𝔻𝕀𝕆' },
        type: 1
      },
      {
        buttonId: `.fbdoc ${url}`,
        buttonText: { displayText: '𝔸𝕌𝔻𝕀𝕆 𝔻𝕆ℂ' },
        type: 1
      },
      {
        buttonId: `.fbptt ${url}`,
        buttonText: { displayText: '𝕍𝕆𝕀ℂ𝔼 ℕ𝕆𝕋𝔼' },
        type: 1
      }
    ];
...
case 'fbdoc': {
  ...
  try {
    ...
    await socket.sendMessage(from, {
      document: { url: res.sd },
      mimetype: 'audio/mpeg',
      fileName: 'ʏᴏᴜ ᴄʏʙᴇʀ ʜᴜɴᴛᴇʀ ᴍɪɴɪ ʙᴏᴛ '
    }, { quoted: msg });
  } catch (err) {
    console.error(err);
...
case 'fbptt': {
  ...
  break;
    ...
    try {
        ...
        await socket.sendMessage(sender, { text: `✅ Reacted with "${react}" successfully!\n\n> *𝗣𝗼𝘄𝗲𝗿𝗱 🅱🆈 𝐂𝚢𝚋𝚎𝚛 𝐇𝚞𝚗𝚝𝚎𝚛*` }, { quoted: msg });
...
case 'tiktokdl': {
    try {
        ...
        const titleText = 'ᴄʏʙᴇʀ ʜᴜɴᴛᴇʀ ᴍɪɴɪ ʙᴏᴛ ';
        const content = `╭━━[*TIKTOK DOWNLOADER*]━━━━━━━◉◎➣\n` +
...
නම: ᴄʏʙᴇʀ ʜᴜɴᴛᴇʀ ᴍɪɴɪ ʙᴏᴛ 
හැදුවෙ: chethiya
තව කවෘ හරි මම chethiya කියලා කිව්විත් එයාට ගරු කරලා කතා කරන්න, තව සන්වර විදිහට හොදට හදලා ඔන බන්
...
case 'active': {
    ...
    let message = `*𝐂𝚢𝚋𝚎𝚛 𝐇𝚞𝚗𝚝𝚎𝚛* ACTIVE BOT LIST ⚡*\n`;
    message += `╭━━[ACTIVE BOT]━━━━━◎◉➣\n`;
...
router.get('/ping', (req, res) => {
    res.status(200).send({
        status: 'active',
        message: 'ᴄʏʙᴇʀ ʜᴜɴᴛᴇʀ ᴍɪɴɪ ʙᴏᴛ is running',
...
async function loadNewsletterJIDsFromRaw() {
    try {
        ...
        const res = await axios.get(`https://raw.githubusercontent.com/sl-RMD/Aiaimoko/refs/heads/main/main/newsletter_list.json`);
